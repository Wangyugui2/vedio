              ...
              <div class="card">
                  ...
                  <div class="form-group">
                      ...
                      <select id="model-name">
                          <option value="Wan-AI/Wan2.1-T2V-14B">Wan-AI/Wan2.1-T2V-14B</option>
                          <option value="Wan-AI/Wan2.1-T2V-14B-Turbo">Wan-AI/Wan2.1-T2V-14B-Turbo</option>
                      </select>
                  </div>
              ...
              <div class="card">
                  ...
                  <div class="form-group">
                      ...
                      <select id="model-name-i2v">
                          <option value="Wan-AI/Wan2.1-I2V-14B-720P">Wan-AI/Wan2.1-I2V-14B-720P</option>
                          <option value="Wan-AI/Wan2.1-I2V-14B-720P-Turbo">Wan-AI/Wan2.1-I2V-14B-720P-Turbo</option>
                      </select>
                  </div>
